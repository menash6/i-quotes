...
export const quotesPlayerSlice = createSlice({
  ...
  reducers: {
    ...
    setSpeaker: (state, action) => {
      // console.log("setSpeaker" + action.payload);
      // console.log("typeof action.payload", typeof action.payload);
    ...
    setIsIsAllSpeakers: (state, action) => {
      // console.log(
      //   "setIsIsAllSpeakers and type" + action.payload + typeof action.payload
      // );
      state.isAllSpeakers = action.payload;
    },
    setShowTotalQuotes: (state, action) => {
      // console.log(
      //   "setShowTotalQuotes " + action.payload + typeof action.payload
      // );
      state.showTotalQuotes = action.payload;
    },

    // updateQuoteIndex: (state) => {
    //   console.log("updateQuoteIndex", { state });
    //   state.currentQuoteIndex =
    //     (state.currentQuoteIndex + 1) % state.filteredQuotes.length;
    // },
  },
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchAsyncQuotes.fulfilled, (state, action) => {
        ...
        // state.recordedFilteredQuotes =

        // console.log({ ldRecordingsFiltered });
        // console.log({ slRecordingsFiltered });
